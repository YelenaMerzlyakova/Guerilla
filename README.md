...
This is a compilation a readme created for the used template and my own additons. 

---------------------------
Part one / Template Read me
...
First of all I would like to credit AJ, the maker of this template. It is thanks to his hard work that I could whip out a decent website in just a few hours. All credit foor the layout and more belongs to them. 


As you can see and read this is an extremely easy template to use and adapt. It is basicaaly a one pager that consists of multiple image boxes hence making it faily easy to use and to implement as long as you keep in mind to make sure you use the correct path. 
